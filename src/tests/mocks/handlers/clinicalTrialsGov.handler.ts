...
export const clinicalTrialsGovHandlers = [
  rest.get(`${BASE_URL}/api/v2/studies?pageSize=1`, (request, response, context) => {
    return response(context.body(JSON.stringify(responseJSON)));
  }),

  // rest.get(getStorageSignedUrl(':filename'), (request, response, context) => {
  //   const file = new Blob(['Hello, world!'], { type: 'text/plain' });
  //   return response(
  //     context.set('Content-Length', file.size.toString()),
  //     context.set('Content-Type', 'text/plain'),
  //     context.set('Content-Disposition', 'inline'),
  //     context.body(file)
  //   );
  // }),
];
  ...
  studies: [
    {
      protocolSection: {
        ...
        sponsorCollaboratorsModule: {
          ...
          leadSponsor: { name: 'Sangath', class: 'OTHER' },
          collaborators: [
            { name: 'Harvard Medical School (HMS and HSDM)', class: 'OTHER' },
            { name: 'London School of Hygiene and Tropical Medicine', class: 'OTHER' },
          ],
        },
        oversightModule: { oversightHasDmc: true, isFdaRegulatedDrug: false, isFdaRegulatedDevice: false },
        descriptionModule: {
          briefSummary:
        ...
        designModule: {
          ...
          designInfo: {
            ...
            interventionModelDescription:
              'A two-arm, individually randomized controlled trial with equal allocation of participants between arms.',
            ...
            maskingInfo: {
              ...
              whoMasked: ['INVESTIGATOR', 'OUTCOMES_ASSESSOR'],
            },
          },
          enrollmentInfo: { count: 250, type: 'ACTUAL' },
        },
          ...
          armGroups: [
            {
              ...
              interventionNames: ['Behavioral: Enhanced usual care'],
            },
            {
              label: 'Intervention',
              type: 'EXPERIMENTAL',
              description: "PRIDE 'Step 1' problem-solving intervention.",
              interventionNames: ["Behavioral: PRIDE 'Step 1' problem-solving intervention"],
            },
          ],
          interventions: [
            {
        ...
        ipdSharingStatementModule: {
          ...
          infoTypes: ['STUDY_PROTOCOL', 'SAP', 'ICF'],
          timeFrame: '12 months after completion of trial.',
          accessCriteria:
            'Access to data will be granted to researchers after review of requests by PI and in accordance with the guidelines of sponsors, collaborators and funder of the study.',
      ...
      derivedSection: {
        miscInfoModule: { versionHolder: '2023-07-25', modelPredictions: { bmiLimits: { minBmi: 0, maxBmi: 101 } } },
        conditionBrowseModule: {
          meshes: [
            { id: 'D000019966', term: 'Substance-Related Disorders' },
            { id: 'D000010554', term: 'Personality Disorders' },
          ],
          ancestors: [
            { id: 'D000001523', term: 'Mental Disorders' },
            { id: 'D000064419', term: 'Chemically-Induced Disorders' },
          ],
          browseLeaves: [
            { id: 'M6748', name: 'Depression', relevance: 'LOW' },
            { id: 'M4505', name: 'Mental Disorders', relevance: 'LOW' },
            { id: 'M6751', name: 'Depressive Disorder', relevance: 'LOW' },
            { id: 'M14163', name: 'Psychotic Disorders', relevance: 'LOW' },
            { id: 'M13152', name: 'Personality Disorders', asFound: 'Personality Disorder', relevance: 'HIGH' },
            { id: 'M21527', name: 'Substance-Related Disorders', asFound: 'Substance Abuse', relevance: 'HIGH' },
            { id: 'M29992', name: 'Chemically-Induced Disorders', relevance: 'LOW' },
          ],
          browseBranches: [
            { abbrev: 'BXM', name: 'Behaviors and Mental Disorders' },
            { abbrev: 'All', name: 'All Conditions' },
            { abbrev: 'BC25', name: 'Substance Related Disorders' },
          ],
        },
